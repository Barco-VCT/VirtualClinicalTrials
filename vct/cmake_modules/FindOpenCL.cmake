...
#  OPENCL_LIBRARIES    		- name of the libraries for opencl
#  OPENCL_LIBRARIES_DIR 	- path to the directory containing the libraries
#  OPENCL_DLL_DIR			- path to the directory containing the dll
#  OPENCL_DLL				- name of the dll
#
...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		IF( ${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" )
			...
			SET(OPENCL_DLL_DIR "$ENV{AMDAPPSDKROOT}/bin/x86_64")
		ELSE (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64")
			SET(OPENCL_LIB_DIR "$ENV{AMDAPPSDKROOT}/lib/x86")
			SET(OPENCL_DLL_DIR "$ENV{AMDAPPSDKROOT}/bin/x86")
		ENDIF( ${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" )
		#2012-12-20 - GUSP: Update the next line, as we want to return the path to the libraries directory, not the path with the library
		#FIND_LIBRARY(OPENCL_LIBRARIES OpenCL.lib PATHS ${OPENCL_LIB_DIR} ENV OpenCL_LIBPATH)
		SET(OPENCL_LIBRARIES "OpenCL.lib")
		SET(OPENCL_LIBRARIES_DIR ${OPENCL_LIB_DIR})
		SET(OPENCL_DLL "OpenCL.dll")
